...
class BasicInfo(BaseModel):
    ...
    location: Optional[str] = Field(default=None, description="location of the candidate")
...
class WorkExperience(BaseModel):
    ...
    description: Optional[str] = Field(default=None, description="description, if not present use 'None' ")
...
class Education(BaseModel):
    ...
    establishment: Optional[str] = Field(default=None, description="establishment where the qualification was obtained")
    country: Optional[str] = Field(default=None, description="country where the qualification was obtained")
    year: Optional[str] = Field(default=None, description="year when the qualification was obtained")
